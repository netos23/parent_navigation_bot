...
import ru.fbtw.navigator.parent_navigation_bot.navigation.MultiLevelNode;
...
public class GraphJsonParser {
	...
	public HashMap<String, Node> parse() throws IOException {
